...
Analogously to [npfl139.ReplayBuffer](https://github.com/ufal/npfl139/blob/master/labs/npfl139/replay_buffer.py),
the buffer elements must be named tuples of data convertible to Numpy arrays
with a constant shape, and the whole replay buffer stores items in a single
named tuple of Numpy arrays containing all the data.
