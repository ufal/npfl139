...
[lunar_lander_interactive.py](https://github.com/ufal/npfl139/tree/master/labs/03/lunar_lander_interative.py)
script.
...
- `expert_episode(seed=None) → episode`: This method generates one expert
  trajectory, where `episode` is a list of triples _(state, action, reward)_,
...
The task is additionally a [_competition_](https://ufal.mff.cuni.cz/courses/npfl139/2526-summer#competitions),
