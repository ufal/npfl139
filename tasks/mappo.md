...
Implement MAPPO in a multi-agent settings. Notably, solve `npfl139/MultiCollect`
(a multi-agent extension of `npfl139/SingleCollect`) with 2 agents,
implemented again by the [multi_collect.py](https://github.com/ufal/npfl139/tree/master/labs/npfl139/envs/multi_collect.py)
module (you can [watch the trained agents](https://ufal.mff.cuni.cz/~straka/courses/npfl139/2526/videos/multi_collect.mp4)).
In the environment, there are $A$ agents, there are also $A$ target places, and each place rewards
...
The [mappo.py](https://github.com/ufal/npfl139/tree/master/labs/10/mappo.py)
