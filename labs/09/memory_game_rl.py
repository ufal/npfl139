    ...
    def __init__(self, env: npfl139.EvaluationEnv, args: argparse.Namespace) -> None:
        ...
        class Model(torch.nn.Module):
            ...
            def forward(self, memory, observation):
                ...
                # TODO(memory_game): Using concatenated encoded input and the read value, produce policy logits
                ...
                # TODO(memory_game): Perform a memory write. First generate a write key from the encoded input
