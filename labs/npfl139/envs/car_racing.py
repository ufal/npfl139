...
#
# This module contains the modified CarRacing-v3 environment:
    ...
    * `continuous=True` specifies if the agent has continuous (true) or discrete (false) actions.
    ...
    def step(self, action: Union[np.ndarray, int]):
        ...
        if self.render_mode == "human":
            self.render()
        return self.state, self.reward - self.prev_reward, terminated, truncated, info
    ...
    def _render(self, mode: str):
        ...
        text = self.fonts[H].render("%03i" % self.reward, True, (255, 255, 255), (0, 0, 0))
        ...
        if mode == "human":
            pygame.event.pump()
            self.clock.tick(self.metadata["render_fps"] / self.frame_skip)
