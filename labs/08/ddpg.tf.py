...
class Network:
    def __init__(self, env: wrappers.EvaluationEnv, args: argparse.Namespace) -> None:
        ...
        #   should apply properly scaled tanh activation.
        #
        # - a target actor as the copy of the actor using `keras.models.clone_model`.
        #
        ...
        #
        # - a target critic as the copy of the critic using `keras.models.clone_model`.
    ...
    def predict_actions(self, states: tf.Tensor) -> np.ndarray:
